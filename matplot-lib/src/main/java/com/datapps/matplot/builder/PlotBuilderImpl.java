...
import com.datapps.matplot.kwargs.MarkerBuilderImpl;
...
public class PlotBuilderImpl implements PlotBuilder {
    ...
    private LineColorBuilder<PlotBuilder> colorBuilder = new LineColorBuilderImpl<>(innerBuilder);
    private MarkerBuilder<PlotBuilder> markerBuilder = new MarkerBuilderImpl<>(innerBuilder);
